              ...
              children: List.generate(
                ...
                (index) => Padding(
                  ...
                  child: RecommendItem(
                    data: courses[index],
                    onTap: () {
                      // Card tap → Navigate to course details (default tab)
                      AppNavigator.to(
                        context,
                        CourseDetailPage(
                          course: courses[index],
                          initialTab: 0, // Overview tab
                        ),
                      );
                    },
                    onPdfTap: () {
                      // PDF icon tap → Navigate to Exercises tab
                      AppNavigator.to(
                        context,
                        CourseDetailPage(
                          course: courses[index],
                          initialTab: 2, // Exercises tab (adjust index as needed)
                        ),
                      );
                    },
                  ),
